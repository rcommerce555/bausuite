          ...
          <div className="space-y-6">
            <div className="rounded-[24px] border border-slate-200 bg-white p-6 shadow-soft">
              ...
              <div className="mt-5">
                ...
                <div className="mt-6">
  <h3 className="text-sm font-semibold text-slate-900">Hauptblocker</h3>
  <p className="mt-2 text-sm leading-6 text-slate-600">{result.main_blocker}</p>
</div>

<div className="mt-6">
  <h3 className="text-sm font-semibold text-slate-900">Ursache</h3>
  <p className="mt-2 text-sm leading-6 text-slate-600">{result.root_cause}</p>
</div>
